...
| **alegrix** | Product Owner / Developer | Defined project vision and feature priorities. Implemented user management, the public Database API, the ORM layer, and contributed to backend route development. |
| **ameduboi** | Developer | Set up the frontend and backend frameworks (React + Fastify). Built the modular UI design system, implemented multilanguage support (i18n), and ensured multi-browser compatibility. |
...
| GitHub OAuth Login | Authenticate via GitHub using OAuth 2.0 | bfiquet |
| User Profiles | View and edit profile information (avatar, email); view other users' profiles | alegrix, ameduboi |
| Avatar Upload | Upload a custom avatar image; default avatar provided | alegrix |
| Friends System | Send, accept, refuse, and remove friend requests; view friends list | bfiquet, alegrix |
| Real-time Chat | WebSocket-based direct messaging with conversation history | bfiquet |
...
| Spectator-ready Architecture | WebSocket game architecture supports spectating | abosc |
...
| # | Grade | Title | Owner(s) | Points |
|:-:|:---:|:---|:---:|:---:|
| 1 | Major | Front and back Frameworks | ameduboi | 2 |
| 2 | Major | Real-time Features | abosc, bfiquet | 2 |
| 3 | Major | User Interactions | bfiquet | 2 |
| 4 | Major | Database API | alegrix | 2 |
| 5 | Major | User Management | alegrix | 2 |
| 6 | Major | Game | abosc | 2 |
| 7 | Major | Remote Play | abosc | 2 |
| 8 | Major | Multiplayer | abosc | 2 |
| 9 | Major | Microservices | jguelen | 2 |
| 10 | Minor | ORM | alegrix | 1 |
| 11 | Minor | Modular Design | ameduboi | 1 |
| 12 | Minor | Multilanguage | ameduboi | 1 |
| 13 | Minor | Multi-browser Support | ameduboi | 1 |
| | | | **Total** | **22** |

### Module Details

#### 1. Front and back Frameworks (Major) — *ameduboi*
...
#### 2. Real-time Features (Major) — *abosc, bfiquet*
...
#### 3. User Interactions (Major) — *bfiquet*
...
#### 5. User Management (Major) — *alegrix*
...
| **Prisma 7.1** | ORM with type-safe queries and migrations |
...
3. **Create the secrets directory** and populate it with the required secret files:
   ...
   | File | Description |
   |:---|:---|
   | `secrets/github_oauth_id` | GitHub OAuth App Client ID |
   | `secrets/github_oauth_secret` | GitHub OAuth App Client Secret |
...
<!-- TODO: Each team member should fill in their detailed contributions below. -->
...
**abosc:**
<!-- TODO: Describe how AI was used (or not) — for which tasks and which parts of the project. -->
