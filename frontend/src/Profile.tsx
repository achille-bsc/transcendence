...
function Profile({ children = "username" }) {
	return (
		<Main> 
			<div className="flex">
				<div className="w-[30vw] min-h-screen bg-black text-purple-900 text-[15px] md:text-[20px] font-bold p-4">
					<p>Sidebar</p>
				</div>
				<div className="flex-1 flex flex-col items-center">
					<div className="w-[40vw] flex flex-col items-center space-y-4 p-6">
						...
						<div className="grid grid-cols-3 w-full gap-6 text-purple-900 text-[10px] md:text-[25px] font-bold">
